...
Date.prototype.format = function (formatString) {
    var dayNames = ["Ndz.", "Pon.", "Wt.", "Śr.", "Cz.", "Pt.", "So.", "Niedziela", "Poniedziałek", "Wtorek", "Środa", "Czwartek", "Piątek", "Sobota"];
    var monthNames = ["Sty.", "Lut.", "Mar.", "Kwi.", "Maj", "Cze.", "Lip.", "Sier.", "Wrz.", "Paź.", "Lis.", "Gru.", "Styczeń", "Luty", "Marzec", "Kwiecień", "Maj", "Czerwiec", "Lipiec", "Sierpień", "Wrzesień", "Październik", "Listopad", "Grudzień"];
